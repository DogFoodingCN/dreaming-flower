...
- A responsive homepage usable on mobile and desktop
- Dreaming Flower / DF identity
- `dogfooding.cn` positioning where relevant
- Galaxy-inspired entrance visual
...
Homepage module interactions may reveal labels, descriptions, or coming-soon states. They should not imply that full module experiences exist in the MVP.
